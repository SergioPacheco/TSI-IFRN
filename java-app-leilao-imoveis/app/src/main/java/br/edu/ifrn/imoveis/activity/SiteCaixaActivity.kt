...
import kotlinx.android.synthetic.main.activity_site_caixa.*

class SiteCaixaActivity : BaseActivity() {
    private val URL_SOBRE = "http://www1.caixa.gov.br/Simov/busca-imovel.asp?sltTipoBusca=imoveis"
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_site_caixa)
