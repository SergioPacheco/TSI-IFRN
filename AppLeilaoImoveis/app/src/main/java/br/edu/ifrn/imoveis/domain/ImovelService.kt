...
object ImovelService {
    private val BASE_URL = "https://localizaimovel.herokuapp.com/imoveis"

    // Busca os imoveis por tipo (Casas, apartamentos ou terrenos)
    fun getImoveis(tipo: TipoImovel): List<Imovel> {
        val url = "$BASE_URL/tipo?text=${tipo.name}"
