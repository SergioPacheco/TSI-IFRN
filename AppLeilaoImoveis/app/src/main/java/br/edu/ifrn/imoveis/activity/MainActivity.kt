...
class MainActivity : BaseActivity() , NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_item_imoveis_casas -> {
                startActivity<ImoveisActivity>("tipo" to TipoImovel.casa)
            }
            R.id.nav_item_imoveis_apartamentos -> {
                startActivity<ImoveisActivity>("tipo" to TipoImovel.apartamento)
            }
            R.id.nav_item_imoveis_terrenos -> {
                startActivity<ImoveisActivity>("tipo" to TipoImovel.terreno)
            }
            R.id.nav_item_site_caixa -> {
                startActivity<SiteCaixaActivity>()
            }
