...
class ImovelActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupToolbar(R.id.toolbar, imovel.descricao, true)
    ...
    fun initViews() {
        ...
        tDescricao.text = imovel.descricao
        tPreco.text = "R$ "+imovel.preco.toString()
        tModalidadeVenda.text = imovel.modalidadeVenda
        tDesconto.text = "R$ "+imovel.desconto.toString()
        tValorAvalicao.text = "R$ "+imovel.valorAvaliacao.toString()
