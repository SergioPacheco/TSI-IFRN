...
public class VendasController {
	...
	public ModelAndView enviarEmail(Venda venda, BindingResult result, RedirectAttributes attributes, @AuthenticationPrincipal UsuarioSistema usuarioSistema){
		...
		mailer.enviar(venda);
		//System.out.println("###### Logo depois da chamada enviar");
		attributes.addFlashAttribute("mensagem", String.format("Venda Nr: %d salva com sucesso e e-mail enviado!", venda.getCodigo()));
		return new ModelAndView("redirect:/vendas/nova");
	}
	...
	public ModelAndView alterarQuantidadeItem(@PathVariable("codigoCerveja") Cerveja cerveja
		...
		//Altera a quantidade da cerveja
	...
	private void validarVenda(Venda venda, BindingResult result) {
		...
		//Passou a validar aqui neste momento, depois de adicionar os itens
