...
//		this.valorTotalBox.html(Brewer.formatarMoeda(v));//passou para onValoresAlerados
		this.valorTotalItens = valorTotalItens == null ? 0 : valorTotalItens;
	}
	
	function onValorFreteAlterado(evento){
//		console.log('valorFrete: ', $(evento.target).val());
//		console.log('valorFreteBrewer: ', Brewer.recuperarValor($(evento.target).val()));
